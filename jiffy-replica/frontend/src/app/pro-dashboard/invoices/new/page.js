...
import {
  ArrowLeft, Plus, Trash2, Save, Send, Loader2, DollarSign, User, Receipt
} from 'lucide-react';
import { createInvoice, sendInvoice } from '@/store/slices/quotesSlice';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none resize-none"
                />
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl border shadow-sm p-6">
            ...
            <div className="space-y-3">
                ...
                <div key={index} className="grid grid-cols-12 gap-3 items-start">
                  <div className="col-span-12 md:col-span-5">
                    <input
                      ...
                      className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-sm"
                    />
                  </div>
                  ...
                  <div className="col-span-4 md:col-span-2">
                    <select
                      ...
                      className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-sm bg-white"
                    >
                      {UNIT_OPTIONS.map((u) => (
                  ...
                  <div className="col-span-3 md:col-span-2">
                    <div className="relative">
                      ...
                      <input
                        ...
                        step="0.01"
                        placeholder="0.00"
                        className="w-full pl-7 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-sm"
                      />
                    </div>
                  </div>
              ...
              <button
                onClick={addItem}
                className="flex items-center gap-2 text-green-600 hover:text-green-700 text-sm font-medium mt-2"
              >
            ...
            <div className="mt-6 pt-4 border-t">
              <div className="flex flex-col items-end space-y-2">
                  ...
                  <div className="w-28">
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        className="w-full pl-5 pr-2 py-1 border rounded text-sm text-right focus:ring-2 focus:ring-green-500 outline-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 text-lg font-bold border-t pt-2">
                  ...
                  <span className="w-28 text-right text-green-600">${total.toFixed(2)}</span>
                </div>
