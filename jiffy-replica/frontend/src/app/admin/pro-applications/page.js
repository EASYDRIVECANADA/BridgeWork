    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">Pro Applications</h1>
            <p className="text-gray-500 text-sm">Review and manage pro onboarding applications</p>
          </div>
          <button
            onClick={() => { resetAddForm(); setShowAddModal(true); }}
            className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 bg-[#0E7480] text-white rounded-lg font-semibold text-sm hover:bg-[#0c6670] transition-colors"
          >
